...
hook.Add('SetupCloseCaptions', 'SBDELUXE_GLAMROCKCHICACAPTIONS', function()
    ...
    SBDELUXE:AddEnglishCaption(path .. 'ROXY_00016.wav', '<clr:149, 0, 255>You can\'t outrun me!')
    SBDELUXE:AddEnglishCaption(path .. 'ROXY_00017.wav', '<clr:149, 0, 255>You think you\'re better than me?!')
    ...
    SBDELUXE:AddEnglishCaption(path .. 'ROXY_00019.wav', '<clr:149, 0, 255>I found him!')
    SBDELUXE:AddEnglishCaption(path .. 'ROXY_00020.wav', '<clr:149, 0, 255>Over here!')
end)