...
hook.Add('SetupCloseCaptions', 'SBDELUXE_HUMANSCAPTIONS', function()
    ...
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00022.wav', '<clr:255, 255, 255>Why you little brat...')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00023.wav', '<clr:255, 255, 255>I don\'t have time for this!')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00024.wav', '<clr:255, 255, 255>Come on out!... You little monster.')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00025.wav', '<clr:255, 255, 255>You\'re in such big trouble mister.')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00026.wav', '<clr:255, 255, 255>Come on kid! I don\'t have all night!')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00027.wav', '<clr:255, 255, 255>Stop hiding.')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00028.wav', '<clr:255, 255, 255>I bet your parents are worried about you.')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00029.wav', '<clr:255, 255, 255>Are you hungry?')
    SBDELUXE:AddEnglishCaption(path .. 'VANESSA_00030.wav', '<clr:255, 255, 255>Come on out!')
    ...
    SBDELUXE:AddEnglishCaption(path .. 'VANNY_00002_002.wav', '<clr:255, 0, 0>There you are!')
    SBDELUXE:AddEnglishCaption(path .. 'VANNY_00002_003.wav', '<clr:255, 0, 0>There you are!')
